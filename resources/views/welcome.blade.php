...
<html lang="en">
      ...
      <div class="main_container">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-clock-o"></i> Jadwal <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="#">Jadwal Shift Pegawai</a></li>
                    </ul>
                  </li>
        ...
        <div class="right_col" role="main">
          ...
          <div class="row tile_count">
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Calon Pegawai</span>
  ...
  new Chart(document.getElementById("bar-chart"), {
      ...
      data: {
        labels: [
          "Pegawai", "Calon Pegawai","Magang","Sudah Terima Gaji","Belum Terima Gaji"
        ],
        datasets: [
          {
            label: "Jumlah",
