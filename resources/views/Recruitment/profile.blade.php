...
<head>
    ...
    <title>Profile Recruitment</title>
    <!-- Bootstrap -->
...
<body class="nav-md">
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-users"></i> Lamaran <span
    ...
    <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <form class="form-horizontal form-label-left input_mask" action="{{route('profile-atasan.update', auth()->user()->username)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
