        ...
        <div class="modal-dialog" role="document">
            ...
            @method('PATCH')
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" value="{{$p->nominal}}" name="nominal">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">PIC</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" value="{{$p->pic}}" placeholder="Masukan PIC" name="pic">
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            ...
            @method('PATCH')
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="email" class="form-control" value="{{$p->nominal}}" readonly>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Pic</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" Value="{{$p->pic}}" readonly>
                    </div>
                </div>
